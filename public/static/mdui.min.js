...
!(function (t, e) {
      ...
      ? ((n._handled = !0),
        s._immediateFn(function () {
          ...
          if (null !== t) {
            ...
            r(i.promise, e);
          } else (1 === n._state ? r : a)(i.promise, n._value);
        }))
      : n._deferreds.push(i);
  }
  function r(e, t) {
  ...
  function T(o, t, s) {
    ...
    return [0, 1].reduce(function (t, e, n) {
      var i = s + r[n];
      return "border" === s && (i += "Width"), t + parseFloat(k(o, i) || "0");
    }, 0);
  }
  function I(t, e) {
    if ("width" !== e && "height" !== e) return k(t, e);
  ...
  "Promise" in h
    ? h.Promise.prototype.finally || (h.Promise.prototype.finally = e)
    : (h.Promise = s);
  var M = [
  ...
  function K(t) {
    if (!x(t) && !Array.isArray(t)) return "";
    var e = [];
    function s(n, i) {
      var o;
      x(i)
        ? A(i, function (t, e) {
            (o = Array.isArray(i) && !x(e) ? "" : t), s(n + "[" + o + "]", e);
          })
          ...
          (s.onload = function () {
            ...
            if (i)
              if (
                ...
                "parsererror" !== r &&
                  ($(Q.ajaxSuccess, u, "success", n, r, s), t(n));
              } else
                (n =
                  "HEAD" === l
                    ? void 0
                  ...
                  t(n);
            else $(Q.ajaxError, u, (r = "error"), s, r), e(new Error(r));
    ...
    return x(e)
      ...
      ? O(e)
        ? t[et]
          ? t[et]
          : {}
        : ((e = w(e)), t[et] && e in t[et] ? t[et][e] : void 0)
      : (nt(t, (((i = {})[e] = n), i)), n);
  }
  function ot(t, n) {
    var e,
  ...
  function st(e, t) {
    if (e[et]) {
      var n = function (t) {
        (t = w(t)), e[et][t] && ((e[et][t] = null), delete e[et][t]);
      };
      O(t)
        ? ((e[et] = null), delete e[et])
        : E(t)
        ? t
            .split(" ")
            .filter(function (t) {
    ...
    (H.extend = function () {
      ...
      return 1 === t.length
        ? (A(t[0], function (t, e) {
          ...
          this)
        : J.apply(void 0, [t.shift(), t.shift()].concat(t));
    }),
    (H.map = ot),
    (H.merge = F),
    (H.param = K),
      ...
      H.fn[i + "Class"] = function (e) {
        return "remove" !== i || arguments.length
          ? this.each(function (t, n) {
              y(n) &&
                A(
                  (f(e) ? e.call(n, t, n.getAttribute("class") || "") : e)
                    .split(" ")
                    .filter(function (t) {
                      return t;
                    }),
            ...
            A(f(t[0]) ? [t[0].call(o, i, o.innerHTML)] : t, function (t, e) {
              ...
              (!E((n = e)) || ("<" === n[0] && ">" === n[n.length - 1])
                ? i && y(e)
                  ? H(e.cloneNode(!0))
                  : H(e)
                : H(S(e, "div")))[s ? "insertAfter" : "insertBefore"](o);
            });
          })
        );
      };
          ...
          x(a) && a.useCapture && (l = !0),
            t.split(" ").forEach(function (t) {
              if (t) {
                ...
                q[c].push(e), s.addEventListener(e.type, o, l);
              }
              function i(t, e) {
                !1 ===
                  r.apply(
  ...
  function dt(t, e, n, i) {
    var o = "client" + e,
      ...
      r = "offset" + e,
      a = "inner" + e;
    if (v(t)) return 2 === n ? t[a] : C(document)[o];
    if (g(t)) {
      var u = C(t);
  ...
  (H.fn.data = function (t, e) {
    ...
    (H.fn.has = function (t) {
      var e = E(t) ? this.find(t) : H(t),
        n = e.length;
      return this.map(function () {
        for (var t = 0; t < n; t += 1) if (z(this, e[t])) return this;
      });
    }),
    ...
    A(["val", "html", "text"], function (o, t) {
      ...
      function r(t) {
        ...
        if (t.length) {
          var e = t[0];
          return 0 === o && H(e).is("select[multiple]")
            ? ot(H(e).find("option:checked"), function (t) {
                return t.value;
              })
            : e[s];
        }
      ...
      H.fn[t] = function (i) {
        return arguments.length
          ? this.each(function (t, e) {
              ...
              0 === o && Array.isArray(n)
                ? H(e).is("select[multiple]")
                  ? ot(H(e).find("option"), function (t) {
    ...
    (H.fn.index = function (t) {
      return arguments.length
        ? E(t)
          ? H(t).get().indexOf(this[0])
          : this.get().indexOf(H(t)[0])
    ...
    (H.fn.replaceAll = function (t) {
      ...
      return H(t).map(function (t, e) {
        return H(e).replaceWith(t ? n.clone() : n), n.get();
      });
    }),
  ...
  (H.fn.mutation = function () {
    ...
    (H.lockScreen = function () {
      ...
      P.addClass("mdui-locked")
        .width(t)
        .data("_lockscreen_level", ++e);
    }),
    (H.unlockScreen = function (t) {
      void 0 === t && (t = !1);
      var e = t ? 1 : P.data("_lockscreen_level");
      1 < e
        ? P.data("_lockscreen_level", --e)
        : P.data("_lockscreen_level", 0).removeClass("mdui-locked").width("");
    }),
  ...
  function bt(t, e) {
    ...
    p(n) && (this.options.tolerance = { down: n, up: n }), this.enable();
  }
  var xt = {
    tolerance: 5,
    offset: 0,
  ...
  (It.prototype.init = function () {
    ...
    (It.prototype.updateTdCheckbox = function () {
      ...
      this.$tdRows.each(function (t, e) {
        ...
        if ((n.find(".mdui-table-cell-checkbox").remove(), o.selectable)) {
          var i = H(o.createCheckboxHTML("td"))
            .prependTo(n)
    ...
    (It.prototype.updateThCheckbox = function () {
      ...
      this.$thRow.find(".mdui-table-cell-checkbox").remove(),
        this.selectable &&
          (this.$thCheckbox = H(this.createCheckboxHTML("th"))
            ...
            .on("change", function () {
              ...
              (t.selectedRow = n ? t.$tdRows.length : 0),
                ...
                t.$tdRows.each(function (t, e) {
                  n
                    ? H(e).addClass("mdui-table-row-selected")
                    : H(e).removeClass("mdui-table-row-selected");
                });
            }));
    }),
  ...
  function Yt(t) {
    ...
    var a = H();
    r && ((a = H("<span></span>")), i.empty().append(a)),
  ...
  H(function () {
    L.on("input focus blur", ".mdui-textfield-input", { useCapture: !0 }, qt),
      L.on(
        "click",
    ...
    (N.updateTextFields = function (t) {
      (O(t) ? H(".mdui-textfield") : H(t)).each(function (t, e) {
        H(e).find(".mdui-textfield-input").trigger("input", { reInit: !0 });
      });
    });
  ...
  H(function () {
    L.on("input change", Ut, function () {
      ...
      L.on(At, Ut, function (t) {
        Lt(t) &&
          (this.disabled || H(this).parent().removeClass("mdui-slider-focus"));
      }),
      L.on(Rt, Ut, Bt),
  ...
  (Kt.prototype.readjustMenu = function () {
    ...
    (Kt.prototype.handleUpdate = function () {
      ...
      (this.$items = H()),
        ...
        (this.$menu = H('<div class="mdui-select-menu"></div>')
  ...
  function Zt(t, e) {
    ...
    void 0 === e && (e = {}),
      ...
      (this.$indicator = H('<div class="mdui-tab-indicator"></div>').appendTo(
        this.$element
      ));
    var i = window.location.hash;
    i &&
      this.$tabs.each(function (t, e) {
        return H(e).attr("href") !== i || ((n.activeIndex = t), !1);
      }),
      -1 === this.activeIndex &&
        this.$tabs.each(function (t, e) {
          return !H(e).hasClass("mdui-tab-active") || ((n.activeIndex = t), !1);
        }),
    ...
    (Zt.prototype.setActive = function () {
      ...
      this.$tabs.each(function (t, e) {
        ...
        t !== o.activeIndex || o.isDisabled(n)
          ? (n.removeClass("mdui-tab-active"), H(i).hide())
      ...
      B.on(
        ...
        H.throttle(function () {
          n.isDesktop()
            ? (n.overlay &&
                !n.options.overlay &&
                (H.hideOverlay(), (n.overlay = !1), H.unlockScreen()),
  ...
  (ne.prototype.isDesktop = function () {
    ...
    (ne.prototype.swipeSupport = function () {
      ...
      function f(t) {
        return Math.min(
          Math.max("closing" === c ? a - t : h() + a - t, 0),
          h()
        );
      }
      function p(t) {
        ...
        P.off({ touchmove: m, touchend: p, touchcancel: m });
      }
      function m(t) {
      ...
      function i(t) {
        (s = t.touches[0].pageX),
          ...
          ("opened" !== u.state && (n < s || e !== i)) ||
            ((l = !0), P.on({ touchmove: m, touchend: p, touchcancel: m }));
      }
      this.options.swipe && (e || (P.on("touchstart", i), (e = i)));
    }),
    ...
    (ne.prototype.close = function () {
      ...
      this.isOpen() &&
        ...
        this.options.overlay ||
          P.removeClass("mdui-drawer-body-" + this.position),
        this.$element
        ...
        this.overlay &&
          (H.hideOverlay(), (this.overlay = !1), H.unlockScreen()));
    }),
  ...
  function ue(t, e) {
    ...
    void 0 === e && (e = {}),
      ...
      (this.append = !1),
      (this.$element = H(t).first()),
      z(document.body, this.$element[0]) ||
        ((this.append = !0), P.append(this.$element)),
      J(this.options, e),
  ...
  (ue.prototype.triggerEvent = function (t) {
    ...
    (ue.prototype.readjust = function () {
      if (de) {
        ...
        t.height(""), n.height("");
        var o = t.height();
        t.css({ top: (B.height() - o) / 2 + "px", height: o + "px" }),
    ...
    (ue.prototype.transitionEnd = function () {
      this.$element.hasClass("mdui-dialog-open")
        ...
        : ((this.state = "closed"),
          this.triggerEvent("closed"),
          this.$element.hide(),
          re(he).length || de || !fe || (H.unlockScreen(), (fe = !1)),
    ...
    (ue.prototype.destroy = function () {
      this.append && this.$element.remove(),
        re(he).length ||
          de ||
          (ce && (H.hideOverlay(), (ce = null)),
          fe && (H.unlockScreen(), (fe = !1)));
    }),
  ...
  H(function () {
    L.on("click", "[" + pe + "]", function () {
      ...
      var n = H(e).first(),
        i = n.data(me);
      i || ((i = new N.Dialog(n, t)), n.data(me, i)), i.open();
    });
  });
  ...
  (Ce.prototype.isDisabled = function (t) {
    ...
    (Ce.prototype.setPosition = function () {
      ...
      switch (
        ("auto" === r &&
          (r =
            n.top + n.height + i + s + 2 < B.height()
              ? "bottom"
              : i + s + 2 < n.top
              ? "top"
              : i + o + 2 < n.left
              ? "left"
              : n.width + i + o + 2 < B.width() - n.left
              ? "right"
              : "bottom"),
        r)
      ) {
  ...
  H(function () {
    L.on("touchstart mouseover", "[" + $e + "]", function () {
      var t = H(this),
        e = t.data(Ee);
      e || ((e = new N.Tooltip(this, Ct(this, $e))), t.data(Ee, e));
    });
  });
  function Oe(t) {
    (this.options = J({}, ke)),
            ...
            this.$element.transitionEnd(function () {
              "opening" === e.state &&
                ...
                e.$element.on("click", function (t) {
                  H(t.target).hasClass("mdui-snackbar-action") ||
                    e.options.onClick(e);
                }),
                e.options.closeOnOutsideClick &&
                  L.on(jt, e.closeOnOutsideClick),
                e.options.timeout &&
    ...
    H(function () {
      L.on("click", ".mdui-bottom-nav>a", function () {
        ...
        o.children("a").each(function (t, e) {
          var n = i.is(e);
          n && yt("change", "bottomNav", o[0], void 0, { index: t }),
            n
              ? H(e).addClass("mdui-bottom-nav-active")
              : H(e).removeClass("mdui-bottom-nav-active");
        });
      }),
      ...
      if (
        ...
        this.$element.on("mouseover mouseout", ".mdui-menu-item", function (t) {
          ...
          if (void 0 === e.attr("disabled")) {
            if ("mouseover" === n) {
              if (!e.is(i) && z(e[0], i[0])) return;
            } else if ("mouseout" === n && (e.is(i) || z(e[0], i[0]))) return;
    ...
    H(function () {
      L.on("click", "[" + Ae + "]", function () {
        ...
        if (!e) {
          var n = Ct(this, Ae),
            i = n.target;
          delete n.target, (e = new N.Menu(t, i, n)), t.data(De, e), e.toggle();
        }
      });
    }),
    N
